package com.josiel.starwars.config.utils;
...
public class JWTUtils {
    ...
    public static final String TOKEN_SECRET_KEY = "StarWarsAppSecretKey";
    ...
    public static String generateToken(final Integer userId, final String username, final String userRole) {
